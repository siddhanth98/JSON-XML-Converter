...
public class XML {
    ...
    public String display() {
        ...
        if (this.getParents() != null) {
            for (int i = this.getParents().size()-1; i >= 0; i--)
                result.append(" ").append(this.getParents().get(i).getTagName()).append(",");
        }
        ...
        if (!this.isParent()) {
            ...
            if (this.value == null)
                result.append("null");
            else result.append("\"").append(this.value.toString()).append("\"");
            result.append("\n");
        }
